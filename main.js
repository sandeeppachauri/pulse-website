...
.wf-line { position: absolute; top: 20px; left: 50%; right: -50%; height: 1px; background: var(--sky-mid); z-index: 0; }
...
.wf-circle {
  ...
  color: var(--navy); z-index: 1; position: relative;
}
.wf-label { font-size: 12px; color: var(--text-secondary); margin-top: 8px; line-height: 1.45; padding: 0 4px; }
...
.tl-badge { font-size: 11px; font-family: var(--font-mono); color: var(--text-muted); margin-bottom: 4px; }
...
.highlight-num { font-family: var(--font-display); font-weight: 300; color: var(--teal); }
...
@media (prefers-color-scheme: dark) {
  :root {
    ...
    --text-muted: #4a6a88;
    --border: rgba(8,145,178,.16);
    --border-med: rgba(8,145,178,.3);
    --sky: rgba(8,145,178,.12);
    --sky-mid: rgba(8,145,178,.25);
    --sky-soft: rgba(8,145,178,.06);
    --navy: #7ab8e8;
    --navy-light: #5aa0d8;
  }
